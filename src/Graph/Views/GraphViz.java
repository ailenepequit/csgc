...
class GraphPanel extends Panel  {
	...
	static int MAXFLOW = 99999;
    GraphViz graph;  // graph that will be drawn in this panel, pointer to caller class
    ...
    GraphPanel(GraphViz graph) { 
       numNodes = numEdges = 0;
       this.graph = graph; setSize(400,400); setVisible(true);}
 ...
 * Somewhat odd division of responsiblities between Graph and GraphPanel
 */
@SuppressWarnings("serial")
public class GraphViz extends Applet {
    GraphPanel panel;
    GraphPanel panel2;
    int startId;
    int finishId;
